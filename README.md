...
Manage your AngularJS application state into a very predicable way.

See the demo [here](https://angularjs-store-demo.netlify.com/) (Still working in progress)
